...
def sign_up(request):
  '''
  Method to sign-up the user after he has filled all the necessary fields in the form.
  '''
...
def log_in(request):
  '''
  Method to log-in the user after he has filled his credentials and is verified in the database. 
  If the user is already authenticated we redirect him to the list of iusers.
  '''
  if request.method == 'POST':
